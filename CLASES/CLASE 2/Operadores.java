...
class Calculadora {
    ...
    public void dividir() {
        if (this.nro1 == 0 && this.nro2 == 0) {
            ...
            double resultado = (double) this.nro1 / this.nro2;
...
public class Operadores {
    public static void main(String[] args) {
        ...
        do {
            Menu.mostrarMenu();   // ✅ ahora se llama de forma estática
            ...
            switch (opcion) {
                case 1:
                    System.out.println(
                        calculadoraObjeto.getNro1() + " + " + 
                        calculadoraObjeto.getNro2() + " = " + 
                        calculadoraObjeto.sumar()
                    );
                    break;
                case 2:
