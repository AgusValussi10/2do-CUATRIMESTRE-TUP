...
class Calculadora {
    ...
    public void restar() {
        ...
        String mensaje =
                (this.nro1 > this.nro2) ? ("Resultado:" + resultado) : "El resultado es negativo";
...
public class Operadores {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    System.out.println(calculadoraObjeto.getNro1() + "+"
                            + calculadoraObjeto.getNro2() + " = " + calculadoraObjeto.sumar());
                    break;
                case 2:
